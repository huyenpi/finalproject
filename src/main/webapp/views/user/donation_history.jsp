...
<body class="bg-light">
	...
	<!-- import top nav -->
	<h3 class="text-center mt-5">LỊCH SỬ QUYÊN GÓP</h3>
	<!-- bảng danh sách lich su quyen gop--->
	<div class="container mt-md-5 px-md-2">
	...
	<div class="d-flex justify-content-center my-5">
		...
		<div class="mb-5">
			...
			<c:if test="${param.index > 1}">
				<a
					href="<c:url value='/lich-su-quyen-gop?target=donation_history?index=${param.index-1}'/>"
		...
		<div class="d-flex mb-5">
			<c:forEach begin="1" end="${endPage}" var="i">
				<div>
					...
					<a
						href="<c:url value='/lich-su-quyen-gop?target=donation_history?index=${i}'/>"
